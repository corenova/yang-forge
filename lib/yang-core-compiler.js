...
(function() {
  ...
  YangCoreCompiler = (function(superClass) {
    ...
    YangCoreCompiler.compile = function(schema, meta) {
      ...
      if (output != null ? (ref = output.value) != null ? typeof ref.get === "function" ? ref.get('yang' === 'module') : void 0 : void 0 : void 0) {
        output.value.merge(this);
      }
    ...
    YangCoreCompiler.compileStatement = function(statement) {
      ...
      if (!!statement.prf) {
        target = (ref = this.get(statement.prf)) != null ? typeof ref.get === "function" ? ref.get(statement.kw) : void 0 : void 0;
      } else {
